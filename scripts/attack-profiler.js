...
export async function main(ns) {
    ...
    if (canReadMults) {
        ...
        // Fallback with all 1's (neutral multipliers)
        mults = {
            HackingLevel: 1, ServerMaxMoney: 1, CompanyRepGain: 1,
            CrimeSuccessRate: 1, HacknetNodeMoney: 1,
            CorporationValuation: 1, BladeburnerRank: 1
        };
    }
